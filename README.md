...
This repository hosts the files for the Coursera's Getting and Cleaning Data. To get the desired result change the setwd() line in line 5 of run_analysis.R, to your working directory, and then run the code. 

# run_analysis.R
I have put comments for different partitions of the code, so that it is clear what it is doing. Here I explain the code in more detail.
